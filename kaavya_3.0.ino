// Hindi replies included
// Made a robot name kaavya....
//Chatbot done
#include "Arduino.h"
...
// }
  ...
  if (voice.indexOf("your name") > 0){    //starting from the most common question of introduction
                                          //set up the neutral look of Eve
    RandomNumber = random(3, 5);                   //generate random numbers from the range 2 to 4
    ...
    myDFPlayer.play(RandomNumber);
                           ...
                           //set up the happy cute little face
    ...
    myDFPlayer.play(RandomNumber);
              ...
              //set up the saddened face of Eve
